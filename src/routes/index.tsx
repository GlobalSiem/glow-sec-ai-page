...
import {
  Shield, Lock, Network, ServerCog, Activity, Scale, Bug,
      ...
      <section className="relative pt-36 pb-32 px-6">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            ...
            <a href="#contato" className="inline-flex items-center gap-2 rounded-full border-2 px-7 py-3.5 text-base font-semibold border-glow-cyan text-[oklch(0.9_0.14_210)] hover:bg-[oklch(0.82_0.16_210/0.1)] transition">
